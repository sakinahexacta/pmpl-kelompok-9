...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#091831] text-white flex lg:p-6 min-h-screen flex-col">
        <div class="absolute top-0 left-0 w-full -z-10">
            <img 
                src="{{ asset('image/bg-dashboard.png') }}"
                class="w-full h-auto"
            />
            <img 
                src="{{ asset('image/bg-2-dashboard.jpeg') }}"
                class="w-full h-auto"
            />
       ...
       <div class="flex justify-end px-10 mt-3" x-data="{ langOpen: false }">
        ...
        <p class="text-4xl text-white lg:text-5xl font-extrabold text-center tracking-wide leading-normal mt-20 pt-10"
       ...
       <form action="{{ route('kamus') }}" method="GET">
        ...
        <div class="h-[200px] bg-[#091831] w-[1350px] items-center mx-auto rounded-b-xl mb-10">
                <p class="text-lg text-white font-bold text-center tracking-wide leading-normal px-20 py-10">
                    Website yang menyediakan kumpulan istilah (glosarium) yang sering digunakan dalam dunia IT, mulai dari konsep dasar hingga istilah teknis yang lebih kompleks. Setiap istilah disajikan dengan penjelasan yang jelas, ringkas, dan mudah dipahami, sehingga dapat membantu pengguna dari berbagai kalangan, baik pemula, pelajar, maupun praktisi, dalam memahami terminologi IT secara lebih mendalam.
                </p>
        </div>
        <p class="text-4xl lg:text-5xl text-white font-bold mt-20 px-12">
            Pilih Kategori Bidang IT
        </p>
        <p class="text-2xl text-white mt-4 px-12">
            Temukan istilah dan penjelasan sesuai bidang yang kamu cari
        </p>
        <div class="flex gap-10 flex-wrap justify-center mt-20">
            <div class="h-[250px] bg-white w-[340px] items-center mx-auto rounded-xl">
                <img
                    src="{{ asset('image/jarkom.jpeg') }}"
                    class="h-30 mx-auto px-8 pt-8 pb-4"
                />
                <p class="text-xl text-[#7CA4B4] font-bold text-center">
                    Jaringan Komputer
                </p>
            </div>
            <div class="h-[250px] bg-white w-[340px] items-center mx-auto rounded-xl">
                <img
                    src="{{ asset('image/DB.jpg') }}"
                    class="h-30 mx-auto px-8 pt-8 pb-4"
                />
                <p class="text-xl text-[#7CA4B4] font-bold text-center">
                    Basis Data
            ...
            <div class="h-[250px] bg-white w-[340px] items-center mx-auto rounded-xl">
                <img
                    src="{{ asset('image/pemrograman.jpg') }}"
                    class="h-30 mx-auto px-8 pt-8 pb-4"
                />
                <p class="text-xl text-[#7CA4B4] font-bold text-center">
                    Pemrograman
            ...
            <div class="h-[250px] bg-white w-[340px] items-center mx-auto rounded-xl">
                <img
                    src="{{ asset('image/keamanan-siber.webp') }}"
                    class="h-30 mx-auto px-8 pt-8 pb-4"
                />
                <p class="text-xl text-[#7CA4B4] font-bold text-center">
                    Keamanan Siber
            ...
            <div class="h-[250px] bg-white w-[340px] items-center mx-auto rounded-xl">
                <img
                    src="{{ asset('image/komputasi-awan.jpg') }}"
                    class="h-30 mx-auto px-8 pt-8 pb-4"
                />
                <p class="text-xl text-[#7CA4B4] font-bold text-center">
                    Komputasi Awan
